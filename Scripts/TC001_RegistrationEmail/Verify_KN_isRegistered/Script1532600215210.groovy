...
WebUI.setText(findTestObject('Registration_Objects/input_email'), 'dmdqavalid@gmail.com')

WebUI.clearText(findTestObject('Registration_Objects/input_username'))

WebUI.setText(findTestObject('Registration_Objects/input_username'), 'dmdqa-abs-postpaid')
